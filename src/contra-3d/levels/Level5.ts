...
export const LEVEL_5: LevelConfig = {
  ...
  background: { fogColor: '#1a0a0a', fogNear: 3, fogFar: 20, skyColor: '#0f0505', groundColor: '#331a1a', parallaxLayers: [
    { color: '#1a0d0d', depth: 1, scrollFactor: 0.1 }, { color: '#241212', depth: 2, scrollFactor: 0.15 }, { color: '#301818', depth: 3, scrollFactor: 0.2 },
  ]},
  terrain: [
